...
public class opcion_a_jugador1 {
	...
	public static void menu() {
		...
		String opcion = JOptionPane.showInputDialog("JUGADOR 1. Elige una opcion");
	...
	public static void juego() {
		...
		if (numeroBolos() == 0) {
			...
			System.out.println("\n \n Jugador 1 ha terminado el juego! Has obtenido " + puntos + " puntos ");
//			if (opcion_a_jugador2.puntos != 0) System.out.println("\n \n Has terminado el juego! Has obtenido " + opcion_a_jugador2.puntos + " puntos ");
//			if (opcion_a_jugador2.puntos == 0) opcion_a_jugador2.juego();
		}
	}
