...
public class CampoBatalla {
	...
	public static void main(String[] args) {
		...
		if (todosMuertosMalvados() == true) {
			...
			System.out.println("El malvado mas disparado ha sido : " + masDisparadoMalvado() + " con "
					+ masDificilMalvado + " tiros.");
		}
		if (todosMuertosHumanos() == true) {
			System.out.println("\n\nHan ganado los malvados");
			System.out.println("El humano mas disparado ha sido : " + masDisparadoHumano() + " con " + masDificilHumano
					+ " tiros.");
		}
	}
